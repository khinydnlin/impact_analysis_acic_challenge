...
2. Raw Data is available within this repo. Get dataset 1 [here](https://github.com/khinydnlin/impact_analysis_acic_challenge/blob/main/acic_data.csv) and year_data [here](https://github.com/khinydnlin/impact_analysis_acic_challenge/blob/main/acic_year.csv). Two files need to be merged by id.practice in order to run analysis.
3. Data processing and modelling scripts are available [here](https://github.com/khinydnlin/impact_analysis_acic_challenge/blob/main/DiD_analysis_scripts.R).
